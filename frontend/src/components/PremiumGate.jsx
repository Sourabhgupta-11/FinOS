...
export default function PremiumGate({ requiredPlan = 'premium', feature = 'This feature' }) {
  const info = PLAN_INFO[requiredPlan] || PLAN_INFO.premium;
  const Icon = info.icon;

  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
      <div className={`w-16 h-16 ${info.bg} rounded-2xl flex items-center justify-center mb-4`}>
