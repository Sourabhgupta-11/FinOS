...
export default function ProfilePage() {
  ...
  const [avatar, setAvatar] = useState(
    () => localStorage.getItem("finos-avatar") || null,
  );
    ...
    <div className="space-y-6 max-w-xl">
      ...
      <div className="card border-red-100 dark:border-red-900/40">
        ...
        <button
          ...
          disabled={isDeleting}
          className="text-sm text-red-600 dark:text-red-400 border border-red-200 dark:border-red-800 px-4 py-2 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
